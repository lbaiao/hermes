...
SETTINGS.DROPS.MAX_NUMBER_OF_DROPS = 4;

% Minimum number of drops - positive integer
SETTINGS.DROPS.MIN_NUMBER_OF_DROPS = 2;
...
SETTINGS.SNR.TYPE = enum.snr.Type.EBNO_EFFECTIVE;
% A list of permitted values may be found at:
% src\+enum\+snr\Type.m
...
SETTINGS.SCENARIO.NODE{2}.VELOCITY = 20;
...
SETTINGS.SCENARIO.MODEM{2}.LLR_METHOD = enum.modem.LlrMethod.NEAREST_AWGN;
% A list of permitted values may be found at:
